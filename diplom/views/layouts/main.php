        ...
        <?php
            ...
            echo Nav::widget([
                ...
                'items' => [
                  ...
                  // (Yii::$app->user->identity->getRole() === 20) ? ['label' => 'KK', 'url' => ['/site/contact']] : ['label' => 'Контакты', 'url' => ['/site/contact']],
                ],
            ]);
            NavBar::end();
        ?>
...
<!--        --><?/*= Breadcrumbs::widget([
        ...
        <div class="mobile_menu_container">
            <div class="mobile_menu_content">
                <ul>
                    <li><a href="<?=Yii::$app->urlManager->createUrl(['site/subject', 'id' => 1])?>">Русский&nbsp;язык</a></li>
                    <li><a href="<?=Yii::$app->urlManager->createUrl(['site/subject', 'id' => 2])?>">Литература</a></li>
                    <li><a href="<?=Yii::$app->urlManager->createUrl(['site/subject', 'id' => 3])?>">Математика</a></li>
                    <li><a href="<?=Yii::$app->urlManager->createUrl(['site/subject', 'id' => 4])?>">История</a></li>
                    <li><a href="<?=Yii::$app->urlManager->createUrl(['site/subject', 'id' => 5])?>">Информатика</a></li>
                    <li><a href="<?=Yii::$app->urlManager->createUrl(['site/subject', 'id' => 6])?>">Физика</a></li>
                    <li><a href="<?=Yii::$app->urlManager->createUrl(['site/subject', 'id' => 7])?>">Химия</a></li>
                    <li><a href="<?=Yii::$app->urlManager->createUrl(['site/subject', 'id' => 8])?>">География</a></li>
                    <li><a href="<?=Yii::$app->urlManager->createUrl(['site/subject', 'id' => 9])?>">Биология</a></li>
                    <li><a href="<?=Yii::$app->urlManager->createUrl(['site/subject', 'id' => 10])?>">Английский&nbsp;язык</a></li>
                    <li><a href="<?=Yii::$app->urlManager->createUrl(['site/subject', 'id' => 11])?>">Обществознание</a></li>
                </ul>
            </div>
        </div>
