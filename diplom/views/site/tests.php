        ...
        if ($subtheme->mainTheme != $theme)
        {
           // echo "<h4>".$subtheme->mainTheme->theme."</h4>";
            ...
            echo    '<div class="contents_item_level2">
				        ...
				        <ul class="contents_item_body_level2">';
            $theme = $subtheme->mainTheme;
        }

        echo "<li><a href=".Yii::$app->urlManager->createUrl(['site/chosen', 'type' => 'test', 'subthemeID' => $subtheme->id]).">".$subtheme->subtheme."</a></li>";
