...
/*        if (Yii::$app->getUser()->isGuest) {
  ...
  //  public function actionTesting($testID, $testName, $curQuestion, $time)
    public function actionTesting($testID, $time)
    {
       ...
       // $testID = 1;
        ...
        return $this->render('testing', ["testID" => $testID,
            "size" => $size,
            "time" => $time,
            "questions" => $dataArray]);
